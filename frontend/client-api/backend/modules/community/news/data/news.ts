...
export const newsData: News[] = [
  {
    ...
    content:
      'El dólar blue ha superado la barrera de los 1.200 pesos, marcando un nuevo récord histórico en el mercado informal de divisas. Este aumento se debe a la creciente incertidumbre económica, las restricciones cambiarias y la falta de confianza en el peso argentino. Los analistas advierten que la volatilidad continuará en los próximos días, mientras el gobierno evalúa nuevas medidas para controlar la escalada del tipo de cambio.',
  ...
  },
  {
    id: 2,
    title:
      'El Bitcoin supera los 50,000 dólares tras una ola de compras institucionales',
    content:
