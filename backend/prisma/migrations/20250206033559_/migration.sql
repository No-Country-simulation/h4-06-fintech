...
-- CreateIndex
CREATE UNIQUE INDEX "wallet_investmentPortfolioId_key" ON "wallet"("investmentPortfolioId");
...
-- AddForeignKey
ALTER TABLE "wallet" ADD CONSTRAINT "wallet_investmentPortfolioId_fkey" FOREIGN KEY ("investmentPortfolioId") REFERENCES "InvestmentPortfolio"("id") ON DELETE CASCADE ON UPDATE CASCADE;
